...
document.getElementById("subtema").style.height = "0%"; 	
document.getElementById("subframe").style.height = "0%"; 	
document.getElementById("subfoto").style.height = "0%"; 	
document.getElementById("subtitle").style.height = "0%"; 	
document.getElementById("subnote").style.height = "0%";	
...
function btnappmake() {
document.getElementById('framepage').src='';
document.getElementById('framepage').src='/HTML/index.html';
}
function btnapphome() {
document.getElementById('framepage').src='';	
document.getElementById('framepage').src='/index.html';
}
function btnapptrand() {
document.getElementById('framepage').src='';	
document.getElementById('framepage').src='/HTML/trand.html';
}
function btnappmaketemp() {
document.getElementById('framepage').src='';	
document.getElementById('framepage').src='/HTML/template.html';
}
